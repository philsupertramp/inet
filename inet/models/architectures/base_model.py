...
from inet.data.constants import LabelType, ModelType
from inet.data.datasets import ImageDataSet
from inet.helpers import extract_labels_and_features, get_train_logdir
...
class TaskModel(Model):
    ...
    def to_tflite(self, quantization_method: 'QuantizationMethod', train_set, test_set):
        ...
        from inet.models.tf_lite.convert_to_tflite import create_quantize_model
